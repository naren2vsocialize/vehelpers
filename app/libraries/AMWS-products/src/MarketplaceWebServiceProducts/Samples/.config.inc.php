<?php
    ...
    * http://aws.amazon.com
    ***********************************************************************/
    define('AWS_ACCESS_KEY_ID', 'AKIAIKS4U5TCACLQZWIA');
    define('AWS_SECRET_ACCESS_KEY', '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');
    ...
    ***********************************************************************/
    define('APPLICATION_NAME', 'vSocialize');
    ...
    * marketplace ID.
    ***********************************************************************/
    define ('MERCHANT_ID', 'A2GFITGK4UNGD9');
